/**Ejercicio9
 * Construir un algoritmo que dado como datos 5 calificaciones de un alumno
 * imprima el promedio y la palabra "aprobado" si el alumno tiene un promedio mayor o igual que 5,
 * y la palabra "no aprobado" en caso contrario
 */

 /*const prompt = require("prompt-sync")();

 const note = prompt("Introduzca un numero del 1 al 10: ")

 if (note< 5){
     console.log("El alumno está suspendo");
 } else if (note >= 5){
